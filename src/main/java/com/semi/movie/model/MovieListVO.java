...
public class MovieListVO {
	...
	public MovieListVO(int movieNo, int genreNo, String title, String runningTime, String synop, String poster,
			String url, int price, Timestamp opendate, int ageRate, Timestamp regdate, int directorNo1, int directorNo2,
			String movieStatus, String stilcut, String genreName) {
		super();
	...
	public String toString() {
		return "MovieListVO [movieNo=" + movieNo + ", genreNo=" + genreNo + ", title=" + title + ", runningTime="
