...
>>>>>>> 568059a807102eb5dab762e04908e488186134e3
...
<<<<<<< HEAD
			<p>영화 정보</p>
			<div>
				<input type="button" class="movie_serch_btn" name="movie_serch_btn" value="영화 검색" >
>>>>>>> branch 'master' of https://github.com/JOSiroo/SemiProject.git
			</div>
