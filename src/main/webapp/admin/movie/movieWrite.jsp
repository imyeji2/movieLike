...
<script type="text/javascript">
	$(function(){
		...
		$('.movie_btn').click(function(){
			...
			var popup = window.open('serch_popup.jsp?type='+type, 'serch', 'width=800px,height=650px,scrollbars=yes');
/* 			$(this).parent().find('.movieWrite_box1')
			.append("<div class='movieWrite_box_in'> <div class='movieWrite_box_in_left'>이름</div>"
											+"<div class='movieWrite_box_in_right'>100</div></div>"); */
		});
	});
		...
		<div class="movieWrite_wrap"><!-- 전체div -->
			...
			<br>
			<div class="movieWrite_box"><!-- 입력폼 div -->
				<input type="button" class="movie_btn btn btn-primary" name="actor" value="배우 추가" >
			...
			<br>
			<div class="movieWrite_box"><!-- 입력폼 div -->
				<input type="button" class="movie_btn btn btn-primary" name="director" value="감독추가" >
