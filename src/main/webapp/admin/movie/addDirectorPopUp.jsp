...
<%
	...
	if(isEdit){
		...
		try{
			vo=service.selectByDirectorNo(Integer.parseInt(no));
			name = vo.getDirectorName();
			img =vo.getDirectorImg();
		...
		<div class="addPopBox">
			...
			<div class="infoBox">
				<div class="infoBox_left" style="line-height: 100px;">
					<img src ="../../images/movie/director/<%=img %>" name ="img" id="peopleImg">
				</div>
