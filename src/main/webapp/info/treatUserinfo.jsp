...
주식회사 무비라이크는(이하 ‘회사’라고 합니다)는 무비라이크(WATCHA PEDIA), 무비라이크(WATCHA) 및 무비라이크 관련 제반 서비스(이하 “서비스”라고 합니다)를 이용하는 회원의 개인정보 보호를 소중하게 생각하고, 회원의 개인정보를 보호하기 위하여 항상 최선을 다해 노력하고 있습니다.
...
7) 무비라이크파티 이용 시 생성된 대화 내역은 서비스 개선을 위한 통계의 목적으로 수집할 수 있습니다.
...
- 수탁업체: 주식회사 더블유서비시즈(주식회사 무비라이크 자회사)
- 위탁 업무: 무비라이크, 무비라이크 고객센터 운영 업무를 목적으로 청약 철회, 해지 예약, 탈퇴 진행 및 분실된 계정 조회 등 고객의 민원 처리
...
3항. 무비라이크파티 이용 시 생성된 대화 내역은 서비스 품질 개선의 목적으로 1년간 보관되며, 그 후 즉시 파기됩니다.
...
- 전화번호: 02-515-9985
- 팩스번호: 02-3478-2202
- 전자우편: cs@watchapedia.co.kr
- 웹문의: https://help.pedia.watcha.co.kr/hc/ko/requests/new
- 주소: 서울특별시 서초구 강남대로 343 신덕빌딩 3층 무비라이크 고객센터 (우 06626)
...
[어린이를 위한 개인정보처리방침]
무비라이크에서 제공하는 서비스(무비라이크, 무비라이크)에 가입하시는 회원님들에게 개인정보의 수집과 이용 목적, 개인정보 보관과 이용 기간에 대해 알려드려요.
