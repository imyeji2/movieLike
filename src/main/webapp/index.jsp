...
<script>
	$(function(){
           ...
           <div class="carousel-inner">
             <div class="carousel-item active" data-bs-interval="3000">
                ...
                <div class="main_box1 f_left">
                   <input type="hidden" name="movieNo" value="1">
                   <div class="main_poster img-thumbnail">
                      <img src="images/movie/content/포스터.jpg">
                   </div><!-- main_poster -->
                   <div class="main_movie_info">
                      <p class="movie_info1">노트북</p>
                      <p class="movie_info2">
                         <span>2004</span>
                         <span>&middot;</span>
                         <span>미국</span>
                      </p>
                      <p class="movie_info2">평균 ★ 4.7</p>
                   </div><!-- main_movie_info -->
                </div><!-- main_box1_margin -->
                <div class="main_box1 f_left">
                   <input type="hidden" name="movieNo" value="26">
                   <div div class="main_poster img-thumbnail">
                      <img src="images/movie/content/포스터1.jpg">
                   </div>
                   <div class="main_movie_info">
                      <p class="movie_info1">늑대소년</p>
                      <p class="movie_info2">
                         <span>2012</span>
                         <span>&middot;</span>
                         <span>한국</span>
                      </p>
                      <p class="movie_info2">평균 ★ 4.6</p>
                ...
                <div class="main_box1 f_left">
                   ...
                   <div class="main_movie_info">
                      <p class="movie_info1">이터널 션샤인</p>
                      <p class="movie_info2">
                         <span>2005</span>
                         <span>&middot;</span>
                         <span>미국</span>
                      </p>
                      <p class="movie_info2">평균 ★ 4.1</p>
                ...
                <div class="main_box1 f_left">
                   ...
                   <div class="main_movie_info">
                      <p class="movie_info1">나는 내일, 어제의 너와 만난다.</p>
                      <p class="movie_info2">
                         <span>2017</span>
                         <span>&middot;</span>
                         <span>미국</span>
      ...
      <article class="main_box">
         <p class="main_title">해덕들 여기 모여라!📢</p>
         <div id="carouselExampleInterval2" class="carousel slide" data-bs-ride="false">
           <div class="carousel-inner">
             <div class="carousel-item active" data-bs-interval="3000">
      ...
      <article class="main_box">
         <p class="main_title">🔥DC VS MCU🔥</p>
         <div id="carouselExampleInterval2" class="carousel slide" data-bs-ride="false">
           <div class="carousel-inner">
             <div class="carousel-item active" data-bs-interval="3000">
